...
ALTER TABLE photos ADD CONSTRAINT fk_photos_users FOREIGN KEY (user_id) REFERENCES users (id) ON DELETE CASCADE;
...
ALTER TABLE comments ADD CONSTRAINT fk_comments_photos FOREIGN KEY (photo_id) REFERENCES photos (id) ON DELETE SET NULL;
ALTER TABLE comments ADD CONSTRAINT fk_comments_users FOREIGN KEY (user_id) REFERENCES users (id) ON DELETE SET NULL;
...
-- ALTER TABLE likes ADD CONSTRAINT fk_likes_photos FOREIGN KEY (photo_id) REFERENCES photos (id) ON DELETE CASCADE;
